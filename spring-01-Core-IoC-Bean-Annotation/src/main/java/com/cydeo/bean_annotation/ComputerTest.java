...
//       Monitor theMonitor=container.getBean(SonyMonitor.class); // give me one bean from the Monitor class
//        Case theCase=container.getBean(Case.class);
//       Motherboard theMotherboard=container.getBean(Motherboard.class);
//        PC myPC=new PC(theCase,theMonitor,theMotherboard);
//        myPC.powerUp();
//
//        Monitor theMonitor2=container.getBean("monitorSony",Monitor.class);// method name is the default bean name
//        Monitor theMonitor3=container.getBean("sony",Monitor.class);
//        Monitor theMonitor4=container.getBean(Monitor.class); // @Primary will be taken as default
